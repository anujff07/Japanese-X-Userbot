...
await app.send_photo("me", "https://telegra.ph//file/1ff32f186d4bf38235be8.jpg", caption="""Hᴇʟʟᴏ sɪʀ ᴍʏsᴇʟғ Jᴀᴘᴀɴᴇsᴇ-X-Usᴇʀʙᴏᴛ, ғᴏʀ {user} Pʀᴏᴛᴇᴄᴛɪᴏɴ 
Hᴇʏ ᴛʜᴇʀᴇ!! I'ᴍ Jᴀᴘᴀɴᴇsᴇ-X-Usᴇʀʙᴏᴛ ᴀɴᴅ I'ᴍ ʜᴇʀᴇ ᴛᴏ Pʀᴏᴛᴇᴄᴛ {user}..
Dᴏɴ'ᴛ Uɴᴅᴇʀ Esᴛɪᴍᴀᴛᴇ ᴍᴇ 😈😈
Mʏ Mᴀsᴛᴇʀ {user}  ɪs ʙᴜsʏ ʀɪɢʜᴛ ɴᴏᴡ !! 
"
